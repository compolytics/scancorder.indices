test_that("test calculating NDVI from CICADA json with single point reflectance and sensor average",
          {
            ...
            expectedNDVI = list(0.27145945207973060098)
            ...
            # Calculate Index
            ndvi_value <- calculate_index('ndvi.xml', data$wavelengths, data$reflectance)
            # Check if the NDVI value is as expected
            expect_equal(data$reflectance, expectedNDVI)
          })
